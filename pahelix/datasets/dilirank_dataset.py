...
__all__ = ['get_default_dilirank_task_names', 'load_dilirank_dataset']


def get_default_dilirank_task_names():
    """Get that default bbbp task names and return the binary labels"""
    return ['label']


def load_dilirank_dataset(data_path, task_names=None):
    ...
    if task_names is None:
        task_names = get_default_dilirank_task_names()
