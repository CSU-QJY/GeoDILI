...
__all__ = ['get_default_diliset_task_names', 'load_diliset_dataset']


def get_default_diliset_task_names():
    """Get that default diliset task names and return the binary labels"""
    return ['smiles']


def load_diliset_dataset(data_path, task_names=None):
    """Load diliset dataset ,process the classification labels and the input information.
    ...
    if task_names is None:
        task_names = get_default_diliset_task_names()
